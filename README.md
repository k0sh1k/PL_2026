# Лабораторная работа №3: Рефакторинг и структурное программирование

**Вариант: 22**

Курс: Языки программирования (1 курс, 2 семестр)
Технологии: Python, Pygame, Рефакторинг

---

## Оглавление

- [Способы улучшения качества кода](#способы-улучшения-качества-кода)
  - [Рефакторинг](#рефакторинг)
  - [Парадигма структурного программирования. Проектирование сверху-вниз](#парадигма-структурного-программирования-проектирование-сверху-вниз)
  - [Проработка интерфейсов функций](#проработка-интерфейсов-функций)
...
Рефакторинг (англ. refactoring) или перепроектирование, переработка кода --- это процесс изменения внутренней структуры программы, не затрагивающий её внешнего поведения и имеющий целью облегчить понимание её работы.
...
Интерфейс функции --- это описание того, как функция взаимодействует с окружением: какие параметры принимает и какой результат выдает (речь идет не только о возвращаемом значении, но и о действиях, которые функция совершает " вовне" --- например, как в нашем случае, вывод на экран изображения). Интерфейс задает стандарт, благодаря которому мы можем данной функцией пользоваться, даже не зная о том, как именно она устроена внутри.
...
Сделайте себе fork проекта одногруппника, который назначит вам преподаватель.
